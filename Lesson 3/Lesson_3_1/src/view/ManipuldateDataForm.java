...
public class ManipuldateDataForm extends JPanel {
	...
	public ManipuldateDataForm(Model m) {
		...
		btnAddDataPoint.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				new AddDataPointController(ManipuldateDataForm.this.model).act(ManipuldateDataForm.this);
			}
		});
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				new DeleteDataPointController(ManipuldateDataForm.this.model).act(ManipuldateDataForm.this);
			}
		});
		...
		btnEdit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
					...
					new OpenDataPointDialogController(ManipuldateDataForm.this.model).act(ManipuldateDataForm.this);
			}
		});
